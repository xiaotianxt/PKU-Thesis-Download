...
<div style="display: flex; align-items: center; margin: 2em 0; gap: 1em">
  ...
  <a href="https://github.com/xiaotianxt/PKU-Thesis-Download" style="text-decoration: none;">
    <img src="https://img.shields.io/greasyfork/v/484052" alt="version">
  </a>
  <a href="https://github.com/xiaotianxt/PKU-Thesis-Download" style="text-decoration: none;">
    <img src="https://img.shields.io/greasyfork/dt/484052" alt="total installs">
  </a>
  <a href="https://github.com/xiaotianxt/PKU-Thesis-Download" style="text-decoration: none;">
    <img src="https://img.shields.io/greasyfork/l/484052" alt="license">
  </a>
</div>
...
1. 下载[北京师范大学学位论文库](https://etdlib.bnu.edu.cn/index.action)中可查看的论文。
2. 调整论文清晰度。
...
2. 安装[此脚本](https://greasyfork.org/zh-CN/scripts/484052-BNU-thesis-download)。
...
北京师范大学论文平台接口只提供图片下载，因此只能间接获得可编辑的文本。可以使用 OCR 工具识别文本。

如果为了获得整篇文章文本，可以考虑使用 Adobe Acrobat、福昕等 PDF 阅读软件进行扫描。
